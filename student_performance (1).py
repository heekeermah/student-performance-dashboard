...
Original file is located at
    https://colab.research.google.com/drive/1YmsT8MF1ANRj9F63xsgfRwinjxNCqGce
...
# ... (your existing Dash app code) ...

# Initialize and run the Dash app
# app = create_dash_app() # Assuming create_dash_app is defined elsewhere

# Create a Streamlit component to display the Dash app
st.components.v1.html(app.index(), height=1000)  # Adjust height as needed
...
# ... (your existing data loading and app layout code) ...

# Modify the app.run_server call:
def run_dash_app():
    app.run_server(mode='inline', port=8051)  # or any unused port

# Create a Streamlit component to display the Dash app:
st.title("Student Performance Dashboard")  # Add a title for Streamlit
run_dash_app()